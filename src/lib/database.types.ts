    ...
    Functions: {
      ...
      create_order_with_stock: {
        Args: {
          ...
          // Nullable in SQL: create_order_with_stock guards it with
          // `is not null`, so NULL means "no free-delivery threshold" —
          // which is what a COD order needs.
          p_free_shipping_above: number | null;
